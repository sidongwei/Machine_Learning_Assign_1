...
from regression_func import ridge,add_bias,plot_err,nonzeros,performance
...
result = np.concatenate(DATA,axis=1).astype(str)        #transfer to str to avoid error like 0.100000000001
export_data(header,result,"Q5")
